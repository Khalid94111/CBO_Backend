...
namespace CBO.Web.Public.Menus;

public class CBOPublicMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public CBOPublicMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<CBOResource>();

        // Home
        context.Menu.AddItem(
            new ApplicationMenuItem(
                CBOPublicMenus.HomePage,
                l["Menu:HomePage"],
                "~/",
                icon: "fa fa-home",
                order: 1
